...
if os.path.isfile(r"/home/pi/pythonsqlite.db"):
 try:
   cn = sqlite3.connect(r"/home/pi/pythonsqlite.db")
   cur = cn.cursor()
...
def thread1(threadname):
    ...
    def setFactor(factor=100):
        ...
        factorI=factor
        try:
         conn = sqlite3.connect(r"/home/pi/pythonsqlite.db")
...
def thread2(threadname): 
    global VArr,watthours,timeDiff,factorI,MaxWatthours,level1,level2,level3,level4,count,volts,amps
    GAIN16 = 16
    GAIN2_3= 2/3
    ...
    while True:
        ...
        Io = adc.read_adc_difference(3, gain=16)
        Vo = adc.read_adc_difference(0, gain=2)
        print(Io)
